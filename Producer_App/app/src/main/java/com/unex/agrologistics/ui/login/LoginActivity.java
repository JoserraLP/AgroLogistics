...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onStart() {
        ...
        // Get the ProducersViewModel
        this.producersViewModel = ViewModelProviders.of(Objects.requireNonNull(this)).get(ProducersViewModel.class);
        ...
        ProducerRepository producerRepository = ProducerRepository.getInstance(getApplication());
    ...
    private void userLogin() {
        ...
        producersViewModel.getProducerByEmail(email).observe(this, producerItem -> {
            if (producerItem != null) {
                ...
                if (password.equals(producerItem.getPassword())) {
                    // If password is valid
                    // Store the user logged in the preferences
                    SharedPreferences.Editor editor = preferences.edit();
                    editor.putString("name", producerItem.getName());
                    editor.putString("email", producerItem.getEmail());
                    editor.putInt("id", producerItem.getId());
                    editor.apply();
