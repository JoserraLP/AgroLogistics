    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        for(int i=1; i<=12; i++) {
            ...
            eventsViewModel.getProducerEventsFromLogisticCenterByDate(ini,fin).observe(
                ...
                if(producerEventsList.size()>0){
                    // Get month
                    int month = Integer.parseInt(producerEventsList.get(0).getDate().substring(5,7));
                    ...
                    for (ProducerEvent producerEvent : producerEventsList)
                        arr[0].put(Integer.parseInt(producerEvent.getDate().substring(8, 10)),
                                "medium");
