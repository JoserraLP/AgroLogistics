...
public class DeliveryConfirmationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Retrieve consumer id and name
        int consumerId = preferences.getInt("id", -1);
        String consumerName = preferences.getString("name", "");

        // Set the consumer id and name values
        newEvent.setConsumer_id(consumerId);
        newEvent.setConsumer_name(consumerName);
        ...
        confirm.setOnClickListener(v -> {
            ...
            eventsViewModel.postConsumerEvent();
