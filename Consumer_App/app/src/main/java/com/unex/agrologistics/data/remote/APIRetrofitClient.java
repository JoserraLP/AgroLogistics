...
public class APIRetrofitClient {
    ...
    /**
     * Create the retrofit consumer service
     * @return Consumer Service
     */
    public ConsumerService getConsumerServiceAPI(){
        return retrofit.create(ConsumerService.class);
    }

    /**
     * Create the retrofit consumer event service
     * @return Consumer Event Service
     */
    public ConsumerEventService getConsumerEventServiceAPI(){
        return retrofit.create(ConsumerEventService.class);
    }
}
