...
public class EventsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        eventsViewModel.setConsumerId(producerId);

        // Create the ListEventsAdapter object
        ListEventsAdapter listEventsAdapter = new ListEventsAdapter(this.getContext(), eventsViewModel);

        // Get all the events and save it to the adapter
        eventsViewModel.getAllConsumerEvents().observe(requireActivity(),
